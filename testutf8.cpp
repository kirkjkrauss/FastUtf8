// C/C++ testcases for UTF-8-ready routines.
//
...
// code point.
//
bool testindex(uint8_t *pContent, int iIndex, uint32_t uExpectedCodePoint)
{
   bool bPassed = true;
                  ...
                  size_t expectedMatch, size_t expectedTarget, bool bCase)
{
   ...
   bool bAscii = !LenValidateUtf8(pContent, lenContent ? lenContent : len);
   bool bAccumulateFunctionTimes = bAscii ? g_bAccumulateFunctionTimes : false;
   std::chrono::time_point<std::chrono::high_resolution_clock> timeStart;
   std::chrono::time_point<std::chrono::high_resolution_clock> timeFinish;
...
//   TokenLenFindUtf8()
//
bool testfindtoken(uint8_t *pContent, uint8_t *pTokenSet, 
...
//
bool testset_foldcopyandduplicate_utf8(void)
{
...
//
bool testset_separateconcatenateandslice_utf8(void)
{
...
// string pairs.
//
bool testset_compare_ascii(void)
{
   int  nReps;
   bool bCase;
...
//
bool testset_compare_empty(void)
{
   bool bCase = false;       // Start out with case-sensitive tests.
   int  iRelyNull = 0;       // Rely on null string terminators.
   bool bAllPassed = true;
   int  nReps;
...
//
bool testset_compare_utf8(void)
{
...
//
bool testset_wildcompare_wild(void)
{
   const bool bCase = false;  // Perform only case-sensitive tests.
...
//
bool testset_wildcompare_tame(void)
{
   const bool bCase = false;  // Perform only case-sensitive tests.
   const int iRelyNull = 0;   // Rely on null string terminators.
...
//
bool testset_wildcompare_empty(void)
{
   const bool bCase = false;  // Perform only case-sensitive tests.
   const int iRelyNull = 0;   // Rely on null string terminators.
...
//
bool testset_targetedsearch_latin(void)
{
   bool bCase = false;      // Perform case-sensitive tests on the first pass.
...
//
bool testset_targetedsearch_tame(void)
{
   const bool bCase = false;  // Perform only case-sensitive tests.
   const int iRelyNull = 0;   // Rely on null string terminators.
   size_t expectedFirst, expectedLast, expectedMatch, expectedTarget;
...
//
bool testset_targetedsearch_empty(void)
{
   const bool bCase = false;  // Perform only case-sensitive tests.
   const int iRelyNull = 0;   // Rely on null string terminators.
   size_t expectedFirst, expectedLast, expectedMatch, expectedTarget;
...
//
bool validateandconvert_testswithrollup(void)
{
   if (g_bComparePerformance)
   {
...
//
bool foldcopyandduplicate_testswithrollup(void)
{
   bool bAllPassed = true;
...
//
bool separateconcatenateandslice_testswithrollup(void)
{
   bool bAllPassed = true;
...
//
bool compare_testswithrollup(void)
{
   bool bAllPassed = true;
...
//
bool slicecompare_testswithrollup(void)
{
   bool bAllPassed = true;
...
//
bool wildcompare_testswithrollup(void)
{
   bool bAllPassed = true;
...
//
bool targetedsearch_testswithrollup(void)
{
   bool bAllPassed = true;
...
// Tests for UTF-8 tokenset search functions.
//
bool tokensetsearch_testswithrollup(void)
{
   if (g_bComparePerformance)
   {
      ClearAccumulatedTimes();
