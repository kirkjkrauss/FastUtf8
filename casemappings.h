...
extern "C"
{
   ...
   // casemappings.cpp.
   const uint32_t CM08DataLen = 0x100;   // TBD
   ...
   const uint32_t CM00nDataLen = 0x1F00;
   extern uint16_t CM00n[CM00nDataLen];

   const uint32_t CM00nLen = 0x1C6;
   ...
   const uint32_t CM9nnDataLen = 0x1000;
   extern uint32_t CM909[CM9nnDataLen];
   
   const uint32_t CM909Len = 0x4D;
