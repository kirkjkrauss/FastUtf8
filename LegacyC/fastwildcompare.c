// UTF-8-ready C/C++ routines for matching wildcards.
//
...
// THAN NULL CHECKING.
//
inline int  CodePointAdvance(char **ppContent)
{
...
//
inline int  CodePointCompare(char *pContentA, char *pContentB)
{
...
//
inline int  CodePointAdvanceAndCompare(char *pContentA, char **ppContentB)
{
